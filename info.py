...
BOT_TOKEN = environ.get('BOT_TOKEN', '7580350329:AAF_c7C_mfEZdzRl4-sHNXMcOQknNpM-84c')
#---------------------------------------------------------------
#---------------------------------------------------------------
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5665677555').split()]
USERNAME = environ.get('USERNAME', "https://t.me/rahul_srm_1") # ADMIN USERNAME
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002461837985'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/+tYEphly0I2UzNTY1')
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002322816434').split()]
#---------------------------------------------------------------
#---------------------------------------------------------------
...
DATABASE_NAME = environ.get('DATABASE_NAME', "srmmoviesbot")
...
VERIFY_IMG = environ.get("VERIFY_IMG", "https://graph.org/file/dd3dfae88a64f2c513fd7-e83eb4c94e0e14544b.jpg")
